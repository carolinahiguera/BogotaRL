...
sys.path.append("/usr/local/share/sumo-0.27.0/tools")
import agent
exec(compile(open("./agent.py", "rb").read(), "./agent.py", 'exec'))
...
beta = [1,2]
theta = [1.75, 1.75]
agents[0] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
agents[1] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
agents[2] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
agents[3] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
agents[4] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
agents[5] = agent(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
