from sim_ft.agentTF import agentTF
...
beta = [1,2]
theta = [1.75, 1.75]
agentsTF[0] = agentTF(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsTF[1] = agentTF(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsTF[2] = agentTF(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsTF[3] = agentTF(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsTF[4] = agentTF(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
