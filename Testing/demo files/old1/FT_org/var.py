...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[0] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[1] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[2] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[3] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[4] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
...
beta = [1,2]
theta = [1.75, 1.75]
vertexAgents[5] = vertexAgent(ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta)
