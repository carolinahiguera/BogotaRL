...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[0] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[1] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[2] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[3] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[4] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)
...
beta = [1,2]
theta = [1.75, 1.75]
agentsQ[5] = agentQ(ID, listLanes, listEdges, lengthEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors)

del ID, listLanes, listEdges, numberLanes, actionPhases, auxPhases, planProgram, neigbors, beta, theta

num_agentsQ = len(agentsQ)
